...
from agent.simsr_agent import SimSRSacAgent
...
def parse_args():
    ...
    # train
    parser.add_argument('--agent', default='bisim', type=str, choices=['baseline', 'bisim', 'deepmdp', 'simsr'])
    ...
    parser.add_argument('--encoder_lr', default=2e-4, type=float)
    parser.add_argument('--encoder_tau', default=0.005, type=float)
    parser.add_argument('--encoder_stride', default=1, type=int)
    parser.add_argument('--decoder_type', default='pixel', type=str, choices=['pixel', 'identity', 'contrastive', 'reward', 'inverse', 'reconstruction'])
    parser.add_argument('--decoder_lr', default=2e-4, type=float)
...
def evaluate(env, agent, video, num_episodes, L, step, device=None, embed_viz_dir=None, do_carla_metrics=True):
    # carla metrics:
    ...
    episode_reward_total /= num_episodes
    L.log('eval/episode_reward', episode_reward_total, step)
